  ...
  useEffect(() => {
    ...
    if (urlError === "MissingCSRF") {
      ...
      if (typeof window !== "undefined") {
        window.history.replaceState({}, "", "/login/stakeholder")
      }
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <div className="flex justify-center mb-4">
            <MessageCircleHeart className="h-12 w-12" style={{ color: "#25D366" }} />
          </div>
          <h2 className="text-3xl font-bold" style={{ color: "#25D366" }}>
            WifeApp
          </h2>
        </div>
